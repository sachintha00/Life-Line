...
namespace LifeLine
{
    public partial class frmGrade12TO13Student : Form
    {
        public frmGrade12TO13Student()
        {
            InitializeComponent();
            ...
            SMDChildFormOpen.Open(new frmGrade12TO13StudentDash(), pnlChildForm, Color.FromArgb(251, 251, 250));
        ...
        private void subjectInsert()
        {
            if(DBManager.chek("SELECT * FROM `student_subject` WHERE st_roll_id = '" + frmLogin.passingRollId + "'") == 0)
                BackGround.transparent(new frmALselectionSubject());
        }
        ...
        {
            SMDChildFormOpen.Open(new frmGrade12TO13StudentSubjects(), pnlChildForm, Color.FromArgb(251, 251, 250));
        }
