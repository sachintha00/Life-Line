    ...
    if($row = mysqli_fetch_assoc($res)){
        ...
        <form action="" method="post">
                <div class="input-group d-flex">
					<div class="input-box">
						<input type="text" required="" value="<?php echo $row['teach_first_name'] ?>">
						<span class="floatingLabel">First Name</span>
					</div>
					<div class="input-box">
						<input type="text" required="" value="<?php echo $row['teach_middle_name'] ?>">
						<span class="floatingLabel">Middle Name</span>
					</div>
					<div class="input-box">
						<input type="text" required="" value="<?php echo $row['teach_surname'] ?>">
						<span class="floatingLabel">Surname</span>
					</div>
				</div>
                <div class="input-group d-flex">
					<div class="input-box">
						<input type="text" required="" value="<?php echo $row['teach_nic'] ?>">
                ...
                <div class="input-group d-flex">
					...
					<div class="input-box">
						<input type="text" required="" value="<?php echo $row['teach_city'] ?>">
