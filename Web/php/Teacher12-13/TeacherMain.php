    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ...
          ['Grade 12', '<?php echo (int)getRowCount("SELECT COUNT(*) as count FROM `student_account` WHERE st_Grade = 'Grade12'"); ?>', '<?php echo (int)getRowCount("SELECT `st_assignment_id`, COUNT(*) as count FROM `student_assignment_upload` WHERE subject_id = '{$subjectId}' AND grade = 'Grade12' GROUP BY st_assignment_id "); ?>'],
          ['Grade 13', '<?php echo (int)getRowCount("SELECT COUNT(*) as count FROM `student_account` WHERE st_Grade = 'Grade13'"); ?>', '<?php echo (int)getRowCount("SELECT `st_assignment_id`, COUNT(*) as count FROM `student_assignment_upload` WHERE subject_id = '{$subjectId}' AND grade = 'Grade13' GROUP BY st_assignment_id "); ?>']
        ]);
...
<script type="text/javascript">
        ...
        function drawChart() {
            var data = google.visualization.arrayToDataTable([
                ['Task', 'Hours per Day'],
                ['Grade 12', <?php echo (int)getRowCount("SELECT `st_assignment_id`, COUNT(*) as count FROM `student_assignment_upload` WHERE subject_id = '{$subjectId}' AND grade = 'Grade12' GROUP BY st_assignment_id "); ?>],
                ['Grade 13', <?php echo (int)getRowCount("SELECT `st_assignment_id`, COUNT(*) as count FROM `student_assignment_upload` WHERE subject_id = '{$subjectId}' AND grade = 'Grade13' GROUP BY st_assignment_id "); ?>]
            ]);
        ...
        <div class="navigation">
            ...
            <div class="menu">
                ...
                <ul>
                    ...
                    <li><img src="../../resource/editProfile.png" alt=""><a href="../../php/Teacher12-13/profileEdit.php">Edit Profile</a></li>
    ...
    <nav class="side-menu">
        <ul>
            ...
            <div class="menu-items">
                ...
                <li class="dashboard">
                    <a href="../Teacher12-13/TeacherMain.php" class="item list btn">
                ...
                <li class="Subjects">
                    <a href="../Teacher12-13/TeacherGrade.php" class="item list">
            ...
            <div class="prgrssEvents">
                ...
                <div class="grdePercentage PEbox">
                    <div class="alertBox" style="background-color: #094C9B;">
                        ...
                        <h6><?php echo (int)getRowCount("SELECT COUNT(*) as count FROM `student_assignment_upload` WHERE subject_id = '{$subjectId}' AND grade = 'Grade6' GROUP BY student_ID "); ?></h6>
                        <img src="../../resource/attendance.png" alt="">
                    </div>
                    <div class="alertBox" style="background-color: #206491;">
                        <h3>Grade 7</h3>
                        <p>Completed Student</p>
                        <h6><?php echo (int)getRowCount("SELECT COUNT(*) as count FROM `student_assignment_upload` WHERE subject_id = '{$subjectId}' AND grade = 'Grade7' GROUP BY student_ID "); ?></h6>
                        <img src="../../resource/attendance.png" alt="">
                    </div>
                    <div class="alertBox" style="background-color: #094C9B">
                        <h3>Grade 8</h3>
                        <p>Completed Student</p>
                        <h6><?php echo (int)getRowCount("SELECT COUNT(*) as count FROM `student_assignment_upload` WHERE subject_id = '{$subjectId}' AND grade = 'Grade8' GROUP BY student_ID "); ?></h6>
                        <img src="../../resource/attendance.png" alt="">
                    </div>
                    <div class="alertBox" style="background-color: #206491;">
                        <h3>Grade 9</h3>
                        <p>Completed Student</p>
                        <h6><?php echo (int)getRowCount("SELECT COUNT(*) as count FROM `student_assignment_upload` WHERE subject_id = '{$subjectId}' AND grade = 'Grade9' GROUP BY student_ID "); ?></h6>
                        <img src="../../resource/attendance.png" alt="">
                    </div>
                    <div class="alertBox" style="background-color: #094C9B;">
                        <h3>Grade 10</h3>
                        <p>Completed Student</p>
                        <h6><?php echo (int)getRowCount("SELECT COUNT(*) as count FROM `student_assignment_upload` WHERE subject_id = '{$subjectId}' AND grade = 'Grade10' GROUP BY student_ID "); ?></h6>
                        <img src="../../resource/attendance.png" alt="">
                    </div>
                    <div class="alertBox" style="background-color: #206491;">
                        <h3>Grade 11</h3>
                        <p>Completed Student</p>
                        <h6><?php echo (int)getRowCount("SELECT COUNT(*) as count FROM `student_assignment_upload` WHERE subject_id = '{$subjectId}' AND grade = 'Grade11' GROUP BY student_ID "); ?></h6>
                        <img src="../../resource/attendance.png" alt="">
                    </div>
