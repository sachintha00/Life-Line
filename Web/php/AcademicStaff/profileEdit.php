...
?>
<?php
    $result = getValue("SELECT * FROM other_staff_account WHERE staff_roll_id = '{$_SESSION['id']}'");                       
?>
...
<?php
    ...
    if(isset($_POST["submit"])){
        ...
        mysqli_query($connection,"UPDATE `other_staff_account` SET `profile_image`= '{$tmpname}' WHERE staff_roll_id = '{$_SESSION['id']}'");
    }
...
<body>
            ...
            <div class="nav-bar">
                <nav>
                    <ul class="nav-panel">
                        ...
                        <li ><a href="#" id="profile" style="text-transform: capitalize;"><?php echo $result['first_name'] ?></a></li>
            ...
            <ul>
                <li class="logo">
                        ...
                        <div class="mProfileContainer" id="muploaded_image">
                            ...
                            <h1 style="text-transform: capitalize;"><?php echo $result['first_name'] ?></h1></a>
    ...
    <div class="middle">
       <div class="MiddleTopic">
            ...
            <p class="input-box">If there is a change in your profile, please use this form and update. If your first name, middle name and last name also have an ID number, check that it is correct, as well as your address and city</p>
       </div>
    ...
    <div class="RightSide">
        ...
        <div class="RightTopic">
            ...
            <p class="input-box">Update your username and password if needed</p>
        </div>
                ...
                <div class="per-topic">UPDATE YOUR <br/>PROFILE DETAILS</div>
                    <form action="profileEdit.php" method="post" id="profileForm">
                            ...
                            <div class="input-group d-flex">
                                ...
                                <div class="input-box">
                                    <span class="">If you have an identity card,<br> enter its number in here</span>
                                </div>
                            </div>
                            <div class="input-group d-flex">
                                <div class="input-box">
