...
?>
<?php
    $stResult = getValue("SELECT * FROM student_account WHERE st_roll_id  = '{$_SESSION['id']}'");
                                
    $stName = $stResult['st_first_name'];                         
...
<html lang="en">
        ...
        <header>
            <div class="navigation">
                ...
                <div class="menu">
                    ...
                    <p>Grade 12</p> -->
                    <ul>
                        <li><img src="../../resource/Profile DashBoard.png" alt=""><a href="../Student/StudentMain.php">Dashboard</a></li>
                ...
                <div class="nav-bar">
                    <nav>
                        <ul class="nav-panel">
                            ...
                            <li ><a href="#" class="SignIn-Nav" id="profile"><?php echo $stName ?></a></li>
    ...
    <script>
        ...
        function sideBar(){
            ...
            xhttp.open("POST","../Student/ProfilePic.php",true);
            xhttp.send();
        }
